...
$App.NAB={PageList:["NewPage","NewPage1"],PageEnterEffect:["",""],PageCount:2,PageExitEffect:["",""],PageNumber:1,AppScale:1,PageID:"",Hour:"",Hour24:"",Minute:"",Second:"",Time:"",Time24:"",DateShort:"",DateLong:"",DateFull:"",Month:"",MonthNum:"",WeekNum:"",Day:"",DayNum:"",Year:"",ClientWidth:$window.innerWidth,ClientHeight:$window.innerHeight,WindowWidth:$window.outerWidth,WindowHeight:$window.outerHeight,Orientation:$scope.GetOrientation(),OperatingSystem:"",$Watches:{},$Timers:{},$Audio:{}};$scope.__doUpdate=function(){var Now=new Date();$App.NAB.Hour=$filter("date")(Now,"h");$App.NAB.Hour24=$filter("date")(Now,"H");$App.NAB.Minute=$filter("date")(Now,"mm");$App.NAB.Second=$filter("date")(Now,"ss");$App.NAB.Time=$filter("date")(Now,"mediumTime");$App.NAB.Time24=$filter("date")(Now,"H:mm:ss");$App.NAB.DateShort=$filter("date")(Now,"shortDate");$App.NAB.DateLong=$filter("date")(Now,"longDate");$App.NAB.DateFull=$filter("date")(Now,"fullDate");$App.NAB.Month=$filter("date")(Now,"MMMM");$App.NAB.MonthNum=$filter("date")(Now,"M");$App.NAB.WeekNum=$filter("date")(Now,"w");$App.NAB.Day=$filter("date")(Now,"EEEE");$App.NAB.DayNum=$filter("date")(Now,"d");$App.NAB.Year=$filter("date")(Now,"yyyy");};$scope.__doOrientationChange=function(){$App.NAB.Orientation=$scope.GetOrientation();};$scope.__doResize=function(){$App.NAB.ClientWidth=$window.innerWidth;$App.NAB.ClientHeight=$window.innerHeight;$App.NAB.WindowWidth=$window.outerWidth;$App.NAB.WindowHeight=$window.outerHeight;};$scope.__init=function(){angular.element($window).bind("orientationchange.app",function(){$timeout($scope.__doOrientationChange);});angular.element($window).bind("resize.app",function(){$timeout($scope.__doResize);});$interval($scope.__doUpdate,1000);$App.NAB.OperatingSystem=GetPlatform();$scope.__doUpdate();};
$scope.NewPage_pageenter = function() {$scope.HideObject("PushButton70","",80);
$scope.ShowObject("Ellipse2","fadeIn",80);
$scope.HideObject("Ellipse1","",80);
$App.DAY1 = localStorage.getItem("DAY1");
$App.DAY2 = localStorage.getItem("DAY2");
$App.DAY3 = localStorage.getItem("DAY3");
$App.Month1 = localStorage.getItem("Month1");
$App.Month2 = localStorage.getItem("Month2");
$App.Month3 = localStorage.getItem("Month3");
$App.Year1 = localStorage.getItem("Year1");
$App.Year2 = localStorage.getItem("Year2");
$App.Year3 = localStorage.getItem("Year3");
$App.Hr1 = localStorage.getItem("Hr1");
$App.Hr2 = localStorage.getItem("Hr2");
$App.Hr3 = localStorage.getItem("Hr3");
$App.Mn1 = localStorage.getItem("Mn1");
$App.Mn2 = localStorage.getItem("Mn2");
$App.Mn3 = localStorage.getItem("Hn3");};
$scope.NewPage_pageexit = function() {localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
localStorage.setItem("Month2",$App.Month2);
localStorage.setItem("Month3",$App.Month3);
localStorage.setItem("Year1",$App.Year1);
localStorage.setItem("Year2",$App.Year2);
localStorage.setItem("Year3",$App.Year3);
localStorage.setItem("Hr1",$App.Hr1);
localStorage.setItem("Hr2",$App.Hr2);
localStorage.setItem("Hr3",$App.Hr3);
localStorage.setItem("Mn1",$App.Mn1);
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
...
$scope.PushButton12_click = function() {$App.Month1 = "DEC";
$scope.ObjectToFront("PushButton1");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
localStorage.setItem("Month2",$App.Month2);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton11_click = function() {$App.Month1 = "NOV";
$scope.ObjectToFront("PushButton12");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton10_click = function() {$App.Month1 = "OCT";
$scope.ObjectToFront("PushButton11");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton9_click = function() {$App.Month1 = "SEP";
$scope.ObjectToFront("PushButton10");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton8_click = function() {$App.Month1 = "AUG";
$scope.ObjectToFront("PushButton9");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton7_click = function() {$App.Month1 = "JULY";
$scope.ObjectToFront("PushButton8");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton6_click = function() {$App.Month1 = "JUNE";
$scope.ObjectToFront("PushButton7");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton5_click = function() {$App.Month1 = "MAY";
$scope.ObjectToFront("PushButton6");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton4_click = function() {$App.Month1 = "APRIL";
$scope.ObjectToFront("PushButton5");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton3_click = function() {$App.Month1 = "March";
$scope.ObjectToFront("PushButton4");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton2_click = function() {$App.Month1 = "FEB";
$scope.ObjectToFront("PushButton3");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton1_click = function() {$scope.SoundBeep();
$App.Month1 = "Jan";
$scope.ObjectToFront("PushButton2");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton13_click = function() {$App.Month2 = "FEB";
$scope.ObjectToFront("PushButton14");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton14_click = function() {$App.Month2 = "MARCH";
$scope.ObjectToFront("PushButton15");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton15_click = function() {$App.Month2 = "APRIL";
$scope.ObjectToFront("PushButton16");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton16_click = function() {$App.Month2 = "MAY";
$scope.ObjectToFront("PushButton17");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton17_click = function() {$App.Month2 = "JUNE";
$scope.ObjectToFront("PushButton18");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton18_click = function() {$App.Month2 = "JULY";
$scope.ObjectToFront("PushButton19");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton19_click = function() {$App.Month2 = "AUG";
$scope.ObjectToFront("PushButton20");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton20_click = function() {$App.Month2 = "SEPT";
$scope.ObjectToFront("PushButton21");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton21_click = function() {$App.Month2 = "OCT";
$scope.ObjectToFront("PushButton22");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton22_click = function() {$App.Month2 = "NOV";
$scope.ObjectToFront("PushButton23");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton23_click = function() {$App.Month2 = "DEC";
$scope.ObjectToFront("PushButton24");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton24_click = function() {$App.Month2 = "JAN";
$scope.ObjectToFront("PushButton13");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton25_click = function() {$App.DAY1 = $scope.Calculate($App.DAY1+"-1",-1);
if ($App.DAY1 == "32") {
$App.DAY1 = "1";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton26_click = function() {$App.Year1 = $scope.Calculate($App.Year1+"-1",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton27_click = function() {$App.Year1 = $scope.Calculate($App.Year1+"+1",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton28_click = function() {$App.DAY1 = $scope.Calculate($App.DAY1+"+1",-1);
if ($App.DAY1 == "32") {
$App.DAY1 = "1";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton29_click = function() {$App.Year1 = $scope.Calculate($App.Year1+"-10",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton30_click = function() {$App.Year1 = $scope.Calculate($App.Year1+"+10",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton31_click = function() {$App.DAY2 = $scope.Calculate($App.DAY2+"-1",-1);
if ($App.DAY2 == "32") {
$App.DAY2 = "1";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton32_click = function() {$App.DAY2 = $scope.Calculate($App.DAY2+"+1",-1);
if ($App.DAY2 == "32") {
$App.DAY2 = "1";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton33_click = function() {$App.Year2 = $scope.Calculate($App.Year2+"-1",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton34_click = function() {$App.Year2 = $scope.Calculate($App.Year2+"+1",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton35_click = function() {$App.Year2 = $scope.Calculate($App.Year2+"-10",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton36_click = function() {$App.Year2 = $scope.Calculate($App.Year2+"+10",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton51_click = function() {$App.Year3 = $scope.Calculate($App.Year3+"-1",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton52_click = function() {$App.Year3 = $scope.Calculate($App.Year3+"+1",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton37_click = function() {$App.Month3 = "FEB";
$scope.ObjectToFront("PushButton38");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton38_click = function() {$App.Month3 = "MARCH";
$scope.ObjectToFront("PushButton39");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton39_click = function() {$App.Month3 = "APRIL";
$scope.ObjectToFront("PushButton40");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton40_click = function() {$App.Month3 = "MAY";
$scope.ObjectToFront("PushButton41");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton41_click = function() {$App.Month3 = "JUNE";
$scope.ObjectToFront("PushButton42");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton42_click = function() {$App.Month3 = "JULY";
$scope.ObjectToFront("PushButton43");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton43_click = function() {$App.Month3 = "AUG";
$scope.ObjectToFront("PushButton44");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton44_click = function() {$App.Month3 = "SEPT";
$scope.ObjectToFront("PushButton45");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton45_click = function() {$App.Month3 = "OCT";
$scope.ObjectToFront("PushButton46");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton46_click = function() {$App.Month3 = "NOV";
$scope.ObjectToFront("PushButton47");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton47_click = function() {$App.Month3 = "DEC";
$scope.ObjectToFront("PushButton48");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton48_click = function() {$App.Month3 = "JAN";
$scope.ObjectToFront("PushButton37");
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Mn2",$App.Mn2);
localStorage.setItem("Hn3",$App.Mn3);};
$scope.PushButton49_click = function() {$App.DAY3 = $scope.Calculate($App.DAY3+"-1",-1);
if ($App.DAY3 == "32") {
$App.DAY3 = "1";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton50_click = function() {$App.DAY3 = $scope.Calculate($App.DAY3+"+1",-1);
if ($App.DAY3 == "32") {
$App.DAY3 = "1";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton53_click = function() {$App.Year3 = $scope.Calculate($App.Year3+"-10",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton54_click = function() {$App.Year3 = $scope.Calculate($App.Year3+"+10",-1);
localStorage.setItem("DAY1",$App.DAY1);
localStorage.setItem("DAY2",$App.DAY2);
localStorage.setItem("DAY3",$App.DAY3);
localStorage.setItem("Month1",$App.Month1);
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton55_click = function() {$App.Hr1 = $scope.Calculate($App.Hr1+"-1",-1);
if ($App.Hr1 == "25") {
$App.Hr1 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton56_click = function() {$App.Hr1 = $scope.Calculate($App.Hr1+"+1",-1);
if ($App.Hr1 == "25") {
$App.Hr1 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton57_click = function() {$App.Hr2 = $scope.Calculate($App.Hr2+"+1",-1);
if ($App.Hr2 == "25") {
$App.Hr2 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton58_click = function() {$App.Hr2 = $scope.Calculate($App.Hr2+"-1",-1);
if ($App.Hr2 == "25") {
$App.Hr2 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton59_click = function() {$App.Hr3 = $scope.Calculate($App.Hr3+"+1",-1);
if ($App.Hr3 == "25") {
$App.Hr3 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton60_click = function() {$App.Hr3 = $scope.Calculate($App.Hr3+"-1",-1);
if ($App.Hr3 == "25") {
$App.Hr3 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton61_click = function() {$App.Mn1 = $scope.Calculate($App.Mn1+"-1",-1);
if ($App.Mn1 == "61") {
$App.Mn1 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton62_click = function() {$App.Mn1 = $scope.Calculate($App.Mn1+"+1",-1);
if ($App.Mn1 == "61") {
$App.Mn1 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton63_click = function() {$App.Mn2 = $scope.Calculate($App.Mn2+"+1",-1);
if ($App.Mn2 == "61") {
$App.Mn2 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton64_click = function() {$App.Mn2 = $scope.Calculate($App.Mn2+"-1",-1);
if ($App.Mn2 == "61") {
$App.Mn2 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton65_click = function() {$App.Mn3 = $scope.Calculate($App.Mn3+"+1",-1);
if ($App.Mn3 == "61") {
$App.Mn3 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton66_click = function() {$App.Mn3 = $scope.Calculate($App.Mn3+"-1",-1);
if ($App.Mn3 == "61") {
$App.Mn3 = "00";
} else {
};
...
localStorage.setItem("Hn3",$App.Mn3);
$scope.SoundBeep();};
$scope.PushButton67_click = function() {window.document.location.reload();};
$scope.Image3_click = function() {$scope.HideObject("PushButton70","",0);
$scope.HideObject("Ellipse1","fadeOut",40);
$scope.ShowObject("Ellipse2","fadeIn",40);
$App.armed = "";
$scope.ShowObject("PushButton1","",0);
$scope.ShowObject("PushButton2","",0);
$scope.ShowObject("PushButton3","",0);
$scope.ShowObject("PushButton4","",0);
$scope.ShowObject("PushButton5","",0);
$scope.ShowObject("PushButton6","",0);
$scope.ShowObject("PushButton7","",0);
$scope.ShowObject("PushButton8","",0);
$scope.ShowObject("PushButton9","",0);
$scope.ShowObject("PushButton10","",0);
$scope.ShowObject("PushButton11","",0);
$scope.ShowObject("PushButton12","",0);
$scope.ShowObject("PushButton13","",0);
$scope.ShowObject("PushButton14","",0);
$scope.ShowObject("PushButton15","",0);
$scope.ShowObject("PushButton16","",0);
$scope.ShowObject("PushButton17","",0);
$scope.ShowObject("PushButton18","",0);
$scope.ShowObject("PushButton19","",0);
$scope.ShowObject("PushButton20","",0);
$scope.ShowObject("PushButton21","",0);
$scope.ShowObject("PushButton22","",0);
$scope.ShowObject("PushButton23","",0);
$scope.ShowObject("PushButton24","",0);
$scope.ShowObject("PushButton26","",0);
$scope.ShowObject("PushButton26","",0);
$scope.ShowObject("PushButton27","",0);
$scope.ShowObject("PushButton28","",0);
$scope.ShowObject("PushButton29","",0);
$scope.ShowObject("PushButton30","",0);
$scope.ShowObject("PushButton31","",0);
$scope.ShowObject("PushButton32","",0);
$scope.ShowObject("PushButton33","",0);
$scope.ShowObject("PushButton34","",0);
$scope.ShowObject("PushButton35","",0);
$scope.ShowObject("PushButton36","",0);
$scope.ShowObject("PushButton37","",0);
$scope.ShowObject("PushButton38","",0);
$scope.ShowObject("PushButton39","",0);
$scope.ShowObject("PushButton40","",0);
$scope.ShowObject("PushButton41","",0);
$scope.ShowObject("PushButton42","",0);
$scope.ShowObject("PushButton43","",0);
$scope.ShowObject("PushButton44","",0);
$scope.ShowObject("PushButton45","",0);
$scope.ShowObject("PushButton46","",0);
$scope.ShowObject("PushButton47","",0);
$scope.ShowObject("PushButton48","",0);
$scope.ShowObject("PushButton49","",0);
$scope.ShowObject("PushButton50","",0);
$scope.ShowObject("PushButton51","",0);
$scope.ShowObject("PushButton52","",0);
$scope.ShowObject("PushButton53","",0);
$scope.ShowObject("PushButton54","",0);
$scope.ShowObject("PushButton55","",0);
$scope.ShowObject("PushButton56","",0);
$scope.ShowObject("PushButton57","",0);
$scope.ShowObject("PushButton58","",0);
$scope.ShowObject("PushButton59","",0);
$scope.ShowObject("PushButton60","",0);
$scope.ShowObject("PushButton61","",0);
$scope.ShowObject("PushButton62","",0);
$scope.ShowObject("PushButton63","",0);
$scope.ShowObject("PushButton64","",0);
$scope.ShowObject("PushButton65","",0);
$scope.ShowObject("PushButton66","",0);
$scope.ShowObject("PushButton67","",0);
$scope.SoundBeep();};
$scope.Image4_click = function() {$scope.HideObject("Ellipse2","fadeOut",40);
$scope.ShowObject("Ellipse1","fadeIn",40);
$scope.SoundBeep();
$App.armed = "Time Circuits Armed";
$scope.SoundBeep();
$App.armed = "Time Circuits Armed";
$scope.SoundBeep();
$App.armed = "Time Circuits Armed";
...
$App.armed = "Time Circuits Armed";
$scope.SoundBeep();
$scope.HideObject("PushButton1","",0);
$scope.HideObject("PushButton2","",0);
$scope.HideObject("PushButton3","",0);
$scope.HideObject("PushButton4","",0);
$scope.HideObject("PushButton5","",0);
$scope.HideObject("PushButton6","",0);
$scope.HideObject("PushButton7","",0);
$scope.HideObject("PushButton8","",0);
$scope.HideObject("PushButton9","",0);
$scope.HideObject("PushButton10","",0);
$scope.HideObject("PushButton11","",0);
$scope.HideObject("PushButton12","",0);
$scope.HideObject("PushButton13","",0);
$scope.HideObject("PushButton14","",0);
$scope.HideObject("PushButton15","",0);
$scope.HideObject("PushButton16","",0);
$scope.HideObject("PushButton17","",0);
$scope.HideObject("PushButton18","",0);
$scope.HideObject("PushButton19","",0);
$scope.HideObject("PushButton20","",0);
$scope.HideObject("PushButton21","",0);
$scope.HideObject("PushButton22","",0);
$scope.HideObject("PushButton23","",0);
$scope.HideObject("PushButton24","",0);
$scope.HideObject("PushButton26","",0);
$scope.HideObject("PushButton26","",0);
$scope.HideObject("PushButton27","",0);
$scope.HideObject("PushButton28","",0);
$scope.HideObject("PushButton29","",0);
$scope.HideObject("PushButton30","",0);
$scope.HideObject("PushButton31","",0);
$scope.HideObject("PushButton32","",0);
$scope.HideObject("PushButton33","",0);
$scope.HideObject("PushButton34","",0);
$scope.HideObject("PushButton35","",0);
$scope.HideObject("PushButton36","",0);
$scope.HideObject("PushButton37","",0);
$scope.HideObject("PushButton38","",0);
$scope.HideObject("PushButton39","",0);
$scope.HideObject("PushButton40","",0);
$scope.HideObject("PushButton41","",0);
$scope.HideObject("PushButton42","",0);
$scope.HideObject("PushButton43","",0);
$scope.HideObject("PushButton44","",0);
$scope.HideObject("PushButton45","",0);
$scope.HideObject("PushButton46","",0);
$scope.HideObject("PushButton47","",0);
$scope.HideObject("PushButton48","",0);
$scope.HideObject("PushButton49","",0);
$scope.HideObject("PushButton50","",0);
$scope.HideObject("PushButton51","",0);
$scope.HideObject("PushButton52","",0);
$scope.HideObject("PushButton53","",0);
$scope.HideObject("PushButton54","",0);
$scope.HideObject("PushButton55","",0);
$scope.HideObject("PushButton56","",0);
$scope.HideObject("PushButton57","",0);
$scope.HideObject("PushButton58","",0);
$scope.HideObject("PushButton59","",0);
$scope.HideObject("PushButton60","",0);
$scope.HideObject("PushButton61","",0);
$scope.HideObject("PushButton62","",0);
$scope.HideObject("PushButton63","",0);
$scope.HideObject("PushButton64","",0);
$scope.HideObject("PushButton65","",0);
$scope.HideObject("PushButton66","",0);
$scope.HideObject("PushButton67","",0);
$App.armed = "Time Circuits Armed";
$scope.SoundBeep();
$App.armed = "Time Circuits Armed";
$scope.SoundBeep();
...
$App.armed = "Time Circuits Armed";
$scope.SoundBeep();};
$scope.PushButton70_click = function() {$App.DAY1 = "1";
$App.Year1 = "2025";
$App.Month1 = "JAN";
$App.DAY2 = "1";
$App.Year2 = "2025";
...
$App.Mn2 = "00";
$App.Mn3 = "00";
$scope.HideObject("PushButton70","",0);};
$scope.PushButton69_click = function() {$scope.ShowObject("PushButton70","",0);};
});
...
$scope.PushButton68_click = function() {$App.DAY1 = "1";
$App.Year1 = "2025";
$App.Month1 = "JAN";
$App.DAY2 = "1";
$App.Year2 = "2025";
